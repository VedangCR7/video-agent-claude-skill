...
def get_user_input() -> dict:
    ...
    # Get voice style
    print("\n🎤 Step 5: Voice style")
    voice_styles = {"1": "professional", "2": "casual", "3": "dramatic"}
...
def main():
    ...
    safe_description = "".join(
        c for c in user_input["description"][:30] if c.isalnum() or c in (" ", "-", "_")
    ).strip()
    ...
    try:
        ...
        if results["success"]:
            ...
            print(
                f"📊 Estimated duration: {results['generated_content'].estimated_duration:.2f} minutes"
            )
