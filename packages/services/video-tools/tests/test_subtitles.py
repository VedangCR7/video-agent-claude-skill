...
And this is the third line."""
    ...
    success = generate_srt_subtitle_file(
        test_text, output_path, duration=None, words_per_second=2.0
    )
...
It supports styling and positioning."""
    ...
    success = generate_vtt_subtitle_file(
        test_text, output_path, duration=15.0, words_per_second=1.5
    )
...
You can load this subtitle file in any video player."""
    ...
    srt_path = generate_subtitle_for_video(
        sample_video, test_text, format_type="srt", words_per_second=1.5
    )

    # Test VTT generation for video
    vtt_path = generate_subtitle_for_video(
        sample_video, test_text, format_type="vtt", words_per_second=1.5
    )
