...
def add_audio_to_video(
    video_path: Path, audio_path: Path, output_path: Path, replace_audio: bool = False
) -> bool:
...
def mix_multiple_audio_files(
    audio_files: List[Path], output_path: Path, normalize: bool = True
) -> bool:
...
def concatenate_multiple_audio_files(
