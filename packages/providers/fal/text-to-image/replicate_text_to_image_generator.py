...
class ReplicateTextToImageGenerator:
    ...
    def calculate_cost(
        self, model: ReplicateTextToImageModel, num_images: int = 1
    ) -> float:
        """
    ...
    def generate_image(
        ...
        try:
            ...
            if not output_filename:
                ...
                output_filename = (
                    f"replicate_{model_name}_{safe_prompt}_{timestamp}.png"
                )
    ...
    def get_model_info(
        self, model: Optional[ReplicateTextToImageModel] = None
    ) -> Dict[str, Any]:
