...
from ..utils.validators import (
    ...
    validate_reframing_coordinates,
    validate_grid_position,
)
from ..config.constants import MODEL_INFO, DEFAULT_VALUES, REFRAME_ENDPOINTS
...
class PhotonModel(BaseModel):
    ...
    def validate_parameters(self, **kwargs) -> Dict[str, Any]:
        ...
        if (
            auto_center
            and all(c is None for c in coords)
            and input_width
            and input_height
        ):
        ...
        result = {"strength": strength, "aspect_ratio": aspect_ratio}
    ...
    def prepare_arguments(
        ...
        if is_reframe:
            ...
            args = {"image_url": image_url, "aspect_ratio": aspect_ratio}
    ...
    def generate(
        self, prompt: str, image_url: str, output_dir: Optional[str] = None, **kwargs
    ) -> Dict[str, Any]:
        """
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        return {**MODEL_INFO["photon"], "endpoint": self.endpoint}
...
class PhotonBaseModel(BaseModel):
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        return {**MODEL_INFO["photon_base"], "endpoint": self.endpoint}
