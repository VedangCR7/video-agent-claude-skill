...
class KontextModel(BaseModel):
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        return {**MODEL_INFO["kontext"], "endpoint": self.endpoint}
...
class KontextMultiModel(BaseModel):
    ...
    def prepare_arguments(
        self, prompt: str, image_urls: List[str], **kwargs
    ) -> Dict[str, Any]:
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        return {**MODEL_INFO["kontext_multi"], "endpoint": self.endpoint}
