...
def test_environment():
    ...
    required_modules = ["os", "sys", "time", "typing", "pathlib"]
...
def test_configuration():
    ...
    if fal_key:
        ...
        if len(fal_key) < 10:
            print("   ⚠️ FAL_KEY seems too short")
            return False

        return True
    else:
        print("   ❌ FAL_KEY environment variable not found")
        print("   📋 Please set your FAL AI API key:")
        print("      export FAL_KEY='your-api-key-here'")
        print("   Or create a .env file with: FAL_KEY=your-api-key-here")
        return False
...
def test_fal_client():
    ...
    try:
        ...
        print("   ✅ fal_client module loaded")

        # Check if we can access client methods (without calling them)
        if hasattr(fal_client, "subscribe"):
            print("   ✅ fal_client.subscribe method available")
        else:
            print("   ❌ fal_client.subscribe method not found")
            return False

        if hasattr(fal_client, "upload_file"):
            print("   ✅ fal_client.upload_file method available")
        else:
            print("   ❌ fal_client.upload_file method not found")
            return False
...
def test_avatar_generator():
    ...
    try:
        ...
        print("   ✅ FALAvatarGenerator imported successfully")
        ...
        try:
            ...
            print("   ✅ FALAvatarGenerator initialized successfully")

            # Test methods availability
            if hasattr(generator, "generate_avatar_video"):
                print("   ✅ generate_avatar_video method available")
...
def run_all_tests():
    ...
    if passed == total:
        ...
        print("\n📋 Common solutions:")
        print(
            "   - Install missing packages: pip install fal-client requests python-dotenv"
        )
