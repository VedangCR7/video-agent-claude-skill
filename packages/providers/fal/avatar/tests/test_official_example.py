...
def main():
    ...
    print(
        "   Image: https://v3.fal.media/files/panda/HuM21CXMf0q7OO2zbvwhV_c4533aada79a495b90e50e32dc9b83a8.png"
    )
    print(
    ...
    print("   Voice: Bill")
    print(
        "   Prompt: 'An elderly man with a white beard and headphones records audio...'"
    )
    print("   Frames: 136")
    print("   Seed: 42")
    print("   Turbo: True")
    ...
    while True:
        response = (
            input("Do you want to proceed with the official example? (yes/no): ")
            .lower()
            .strip()
        )
    ...
    try:
        ...
        if result and "video" in result:
            ...
            print(
                "📖 Compare with: https://fal.ai/models/fal-ai/ai-avatar/single-text/api"
            )
        else:
            print("❌ Official example generation failed")
            sys.exit(1)
