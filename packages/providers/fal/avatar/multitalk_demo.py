...
def demo_single_person(
    generator: ReplicateMultiTalkGenerator, output_dir: str = "output"
):
    ...
    print("   • Prompt: A person speaking naturally")
    print("   • Frames: 81")
    print("   • Turbo: True")
...
def demo_conversation(
    ...
    # Example parameters (users should replace with actual files)
    image_url = (
        "https://via.placeholder.com/512x512/DDDDDD/FFFFFF?text=Two+People+Photo"
    )
    first_audio_url = (
        "https://via.placeholder.com/1x1/DDDDDD/FFFFFF?text=person1_audio.mp3"
    )
    second_audio_url = (
        "https://via.placeholder.com/1x1/DDDDDD/FFFFFF?text=person2_audio.mp3"
    )
    ...
    print("   • Prompt: A smiling man and woman hosting a podcast")
    print("   • Frames: 120")
    print("   • Turbo: True")
...
def main():
    ...
    parser.add_argument(
        "--single", action="store_true", help="Demo single person video"
    )
    parser.add_argument(
        "--conversation", action="store_true", help="Demo multi-person conversation"
    )
    parser.add_argument("--test", action="store_true", help="Test connection only")
    parser.add_argument(
        "--output-dir", default="output", help="Output directory for videos"
    )
    ...
    try:
        ...
        print(
            "💡 Make sure REPLICATE_API_TOKEN is set in your environment or .env file"
        )
