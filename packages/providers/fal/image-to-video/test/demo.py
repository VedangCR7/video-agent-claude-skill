        ...
        if demo_choice == 0:
            ...
            if os.path.exists(local_image_path):
                ...
                result = generator.generate_video_from_local_image(
                    ...
                    duration="6"
                    if model_name == "fal-ai/minimax/hailuo-02/standard/image-to-video"
                    else "5",
                    output_folder="../output",
                    model=model_name,
                )
                ...
                print(
                    "Please place an image at that location or choose a different demo"
                )
            ...
            print(
                "🔄 Generating with fal-ai/minimax/hailuo-02/standard/image-to-video..."
            )
            ...
            duration_choice = get_user_choice(
                "Select duration:", [f"{d} seconds" for d in duration_options]
            )
