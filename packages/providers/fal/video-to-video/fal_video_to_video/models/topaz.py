...
class TopazModel(BaseModel):
    ...
    def prepare_arguments(self, video_url: str, **kwargs) -> Dict[str, Any]:
        ...
        args = {"video_url": video_url, "upscale_factor": kwargs["upscale_factor"]}
    ...
    def generate(
        self, video_url: str, output_dir: Optional[str] = None, **kwargs
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if "video_url" in processed_response:
                ...
                downloaded_path = download_video(
                    processed_response["video_url"], output_directory
                )
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        return {**MODEL_INFO["topaz"], "endpoint": self.endpoint}
