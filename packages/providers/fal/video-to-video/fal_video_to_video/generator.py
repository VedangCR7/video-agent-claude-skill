...
class FALVideoToVideoGenerator:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        # Initialize models
        self.models = {"thinksound": ThinkSoundModel(), "topaz": TopazModel()}
    ...
    def add_audio_to_video(
        ...
        **kwargs,
        ...
        return model_instance.generate(
            video_url=video_url, output_dir=output_dir, **params
        )
    ...
    def upscale_video(
        ...
        **kwargs,
        ...
        # Prepare parameters
        params = {"upscale_factor": upscale_factor, "target_fps": target_fps, **kwargs}
