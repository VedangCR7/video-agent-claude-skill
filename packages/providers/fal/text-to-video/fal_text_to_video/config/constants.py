...
ModelType = Literal[
    "hailuo_pro", "veo3", "veo3_fast", "kling_2_6_pro", "sora_2", "sora_2_pro"
]
...
# Pricing (USD)
MODEL_PRICING = {
    "hailuo_pro": {"type": "per_video", "cost": 0.08},
    "veo3": {"type": "per_second", "cost_no_audio": 0.50, "cost_with_audio": 0.75},
    "veo3_fast": {"type": "per_second", "cost_no_audio": 0.25, "cost_with_audio": 0.40},
    "kling_2_6_pro": {
        "type": "per_second",
        "cost_no_audio": 0.07,
        "cost_with_audio": 0.14,
    },
    "sora_2": {"type": "per_second", "cost": 0.10},
    "sora_2_pro": {"type": "per_second", "cost_720p": 0.30, "cost_1080p": 0.50},
}
...
DEFAULT_VALUES = {
    "hailuo_pro": {"prompt_optimizer": True},
    "veo3": {
        "duration": "8s",
        "aspect_ratio": "16:9",
        "generate_audio": True,
    ...
    "veo3_fast": {"duration": "8s", "aspect_ratio": "16:9", "generate_audio": True},
    "kling_2_6_pro": {
        "duration": "5",
        "aspect_ratio": "16:9",
