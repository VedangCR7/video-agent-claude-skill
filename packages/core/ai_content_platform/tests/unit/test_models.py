...
class TestStepConfig:
    ...
    def test_valid_step_config(self):
        ...
        config = StepConfig(
            ...
            parameters={"prompt": "A test image", "model": "flux-1-dev"},
        )
    ...
    def test_invalid_step_config(self):
        ...
        # Invalid step type
        with pytest.raises(ValidationError):
            StepConfig(name="invalid", step_type="invalid_type", parameters={})
...
class TestParallelStepConfig:
    ...
    def test_valid_parallel_step_config(self):
        ...
        parallel_config = ParallelStepConfig(
            name="parallel_test", parallel_steps=steps, merge_strategy="merge_outputs"
        )
    ...
    def test_empty_parallel_steps(self):
        ...
        with pytest.raises(ValidationError):
            ParallelStepConfig(
                name="empty_parallel", parallel_steps=[], merge_strategy="merge_outputs"
            )
...
class TestPipelineConfig:
    ...
    def test_minimal_pipeline_config(self, sample_step_config):
        ...
        config = PipelineConfig(pipeline_name="minimal", steps=[sample_step_config])
    ...
    def test_invalid_pipeline_config(self):
        ...
        # Empty pipeline name
        with pytest.raises(ValidationError):
            PipelineConfig(pipeline_name="", steps=[])
...
class TestStepResult:
    ...
    def test_step_result_defaults(self):
        ...
        result = StepResult(
            step_id="defaults_123", step_type=StepType.TEXT_TO_IMAGE, success=True
        )
...
class TestModelIntegration:
    ...
    def test_pipeline_with_mixed_steps(self):
        ...
        pipeline = PipelineConfig(
            pipeline_name="mixed_pipeline", steps=[regular_step, parallel_step]
        )
