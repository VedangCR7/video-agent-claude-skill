        ...
        try:
            ...
            if success:
                ...
                return self._create_error_result(
                    result.get("error", "TTS generation failed"), step.model
                )

        except Exception as e:
            return self._create_error_result(
                f"TTS execution failed: {str(e)}", step.model
            )
    ...
    def execute(
        ...
        **kwargs,
        ...
        try:
            ...
            second_audio_url = params.get("second_audio_url") or params.get(
                "second_audio"
            )
            ...
            if not first_audio_url:
                return self._create_error_result(
                    "No audio provided. Use 'first_audio_url' parameter.", step.model
                )
            ...
            if video_url:
                ...
                return {
                    ...
                    if output_path and __import__("os").path.exists(output_path)
                    else None,
                ...
                return self._create_error_result(
                    "No video URL in MultiTalk response", step.model
                )

        except Exception as e:
            print(f"MultiTalk generation failed: {e}")
            return self._create_error_result(
                f"MultiTalk generation failed: {str(e)}", step.model
            )
        ...
        **kwargs,
        ...
        try:
            ...
            if result.success:
                ...
                return self._create_error_result(
                    result.error or "Transcription failed", step.model
                )

        except Exception as e:
            return self._create_error_result(
                f"Speech-to-text execution failed: {str(e)}", step.model
            )
