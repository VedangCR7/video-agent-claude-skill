    ...
    def _initialize_generator(self):
        ...
        try:
            ...
            if fal_image_to_image_path.exists():
                ...
                print(
                    "❌ FAL Image-to-Image directory not found at:",
                    fal_image_to_image_path,
                )
                self.generator = None
        ...
        **kwargs,
        ...
        if not self.generator:
            return ImageToImageResult(
                success=False, error="FAL Image-to-Image generator not available"
            )
            ...
            if source_image.startswith(("http://", "https://")):
                ...
                result = self.generator.modify_image(
                    ...
                    **{
                        ...
                        if k not in ["prompt", "source_image", "model", "output_dir"]
                    },
                )
            else:
                # Local image path
