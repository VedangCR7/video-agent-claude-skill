...
class MockImageToVideoGenerator:
    ...
    def generate_video(
        self, prompt: str, image_url: str, model: str = "hailuo", **kwargs
    ):
        """Mock generate_video method."""
        return self._mock_result(prompt, model)

    def generate_video_from_local_image(
        self, prompt: str, image_path: str, model: str = "hailuo", **kwargs
    ):
...
class UnifiedImageToVideoGenerator(BaseContentModel):
    ...
    def generate(
        self, input_data: Dict[str, Any], model: str = "auto", **kwargs
    ) -> ModelResult:
        """
    ...
    def _generate_with_fal(
        self, prompt: str, image_url: str, model: str, **kwargs
    ) -> ModelResult:
    ...
    def _generate_with_veo(
        ...
        return self._create_error_result(
            model, "Google Veo integration not yet implemented"
        )
    ...
    def compare_models(
        self, prompt: str, image_url: str, models: List[str] = None
